...
//        .\build\native\nativeCompile\dozent.exe --spring.profiles.active=dev --logging.file.name=.\build\log\application.log
//        .\build\native\nativeCompile\dozent.exe --spring.datasource.url=jdbc:h2:mem:testdb --spring.datasource.username=sa --spring.datasource.password="" --logging.file.name=.\build\log\application.log
//
...
dependencies {
    ...
    // build\generated\sources\annotationProcessor\java\main\com.acme.dozent\entity\Dozent_.java
