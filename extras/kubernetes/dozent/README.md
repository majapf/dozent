...
| datasource.url | string | `"jdbc:postgresql://localhost/dozent"` | URL für den DB-Zugriff |
| datasource.username | string | `"dozent"` | Benutzername für das DB-System |
...
| image.name | string | `"dozent"` | Name des Image |
| image.pullPolicy | string | `"Always"` | Pull-Policy für das Image |
| image.repository | string | `"majapfannendoerfer"` | Repository als Präfix beim Image-Namen |
