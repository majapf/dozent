...
--        chown postgres:postgres /var/lib/postgresql/tablespace/dozent
...
-- (5) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-dozent.sql
--        psql --dbname=dozent --username=dozent --file=/sql/create-schema-dozent.sql
...
CREATE ROLE dozent LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE dozent;

-- https://www.postgresql.org/docs/current/sql-grant.html
GRANT ALL ON DATABASE dozent TO dozent;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE dozentspace OWNER dozent LOCATION '/var/lib/postgresql/tablespace/dozent';
